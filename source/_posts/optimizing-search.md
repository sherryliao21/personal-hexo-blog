...
```
// 節點層，依此類推
以節點為單位去打包，用 Promise.all() 同時去做節點內該做的事情，並同時結束（最後一個返回的節點 result 的時間，代表其他節點都完成了）
```
...
<p align="center">
  <img src="../optimizing-search/05.png" style="margin: 20px; height: 300px; width: 600px"/>
</p>


<p align="center">
  <img src="../optimizing-search/06.png" style="margin: 20px; height: 300px; width: 600px"/>
</p>
...
<p align="center">
  <img src="../optimizing-search/07.png" style="margin: 20px; height: 300px; width: 600px"/>
</p>
